...
abstract class Handle<T extends NativeType> {
  Pointer<T> _pointer;
  late final Pointer<Dart_FinalizableHandle> _finalizableHandle;
...
class RealmNotificationTokenHandle extends Handle<realm_notification_token> {
  RealmNotificationTokenHandle._(Pointer<realm_notification_token> pointer) : super(pointer, 256); // TODO: What should gc hint be?
}
